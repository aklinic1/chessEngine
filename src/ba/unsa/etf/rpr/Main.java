...
public class Main {
     public static void main(String[] args) {
    	...
    	while(true){
            ...
            if(pozicija.charAt(0) == 'K'){ type = King.class; }
            else if(pozicija.charAt(0) == 'Q'){ type = Queen.class;}
            else if(pozicija.charAt(0) == 'R'){ type = Rook.class;}
            else if(pozicija.charAt(0) == 'B'){ type = Bishop.class;}
            else if(pozicija.charAt(0) == 'N'){ type = Knight.class; }
            else if(pozicija.charAt(0) == 'P'){ type = Pawn.class; }
            else continue;      //throw IllegalArgumentException("Figura na slovo " + pozicija.charAt(0) + " ne postoji");
            try {
