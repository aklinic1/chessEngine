...
public class Pawn extends ChessPiece {
    ...
    public boolean checkMove(String position){
        ...
        if(Math.abs(pocetna1 - krajnja1) == 1 && Math.abs(pocetna2 - krajnja2)) return true; //moze se kretati jedno polje dijagonalno pod uslovom
        return false;                                                                          //da je na toj poziciji figura druge boje
    }
}
